...
export JAVA_HOME=/mnt/apps/tools/jdk1.8.0_101 && /mnt/apps/tools/apache-maven-3.3.9/bin/mvn install
copy a new AwsCredentials.properties include AWS AKSK into "src/main/resources/"
export PROJECT_ROOT=[beaver_root] && /mnt/apps/tools/jdk1.8.0_101/bin/java -jar target/gs-rest-rds-eason-0.1.0.jar 2>&1 >/dev/null &
#
